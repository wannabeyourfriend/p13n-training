#!/usr/bin/env bash
set -euo pipefail
MODEL_NAME="qwen3-14b-qa-personamem-lr1e-4"
PORT="${PORT:-8114}"
GPU="${GPU:-0}"
LORA_DIR="/home/2025user/zhou/klab-workspace/model-trainer-deployer/outputs/qwen3_14b_qa_personamem_lastturn_lr1e-4_n1177/final"
